 ...
 useEffect(() => {
  ...
  return (
    ...
    <div className="flex relative flex-col h-full p-6 items-center bg-gradient-to-br from-slate-950 via-slate-800 to-slate-950 rounded-lg w-full max-w-7xl md:h-[90vh] ">
      <a href="/" className="absolute top-6 left-6 z-20 px-4 py-2 rounded-lg bg-yellow-400 text-slate-900 font-bold shadow hover:bg-yellow-300 transition">← Back to Home</a>
      {pokemon ? (
